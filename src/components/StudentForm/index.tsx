...
import { createStudent } from '@/utils/apiService'
...
export default function StudentForm() {
  ...
  async function handleCreateStudent(e: React.FormEvent) {
    ...
    try {
      const res = await createStudent(studentToSend)
      console.log('Učenik kreiran:', res)
      handleAlert()
    } catch (error) {
      console.error('Greška prilikom kreiranja učenika:', error)
    }
  }
