...
import EditLibrarian from '@/components/EditLibrarian'
...
export default function LibrarianPage() {
  ...
  //Funkcija koja kada se klikne na izmijeni podatke stavlja fokus na prvo input polje
  ...
  const handleDeleteLibrarian = async (id: number) => {
    try {
      await deleteUser(id)
      setShowDeleteModal(false)
      router.push('/librarians')
    } catch (err) {
      alert('Greška pri brisanju bibliotekara.')
    }
  }
      ...
      <div className="py-3 text-xl font-medium overflow-y-hidden">
        ...
        >
          <TabContext value={value}>
            ...
            <TabPanel value="1">
              <EditLibrarian data={data} nameInputRef={nameInputRef} />
            </TabPanel>
            <TabPanel value="2">
              <RecordsStudent />
            </TabPanel>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              ...
              <div className="z-50 bg-white p-6 rounded-xl shadow-lg w-[320px] relative text-center">
                ...
                <div className="flex justify-between">
                  <button
                    onClick={() => handleDeleteLibrarian(data.id!)}
